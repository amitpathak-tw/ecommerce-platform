...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> product(ProductNotFoundException exception, HttpServletRequest request) {
        return error(HttpStatus.NOT_FOUND, "PRODUCT_NOT_FOUND", exception.getMessage(), request, Map.of());
    }

    @ExceptionHandler(CategoryNotFoundException.class)
    ResponseEntity<ErrorResponse> category(CategoryNotFoundException exception, HttpServletRequest request) {
        return error(HttpStatus.NOT_FOUND, "CATEGORY_NOT_FOUND", exception.getMessage(), request, Map.of());
    }
