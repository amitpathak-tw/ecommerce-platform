...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> orderNotFound(OrderNotFoundException exception, HttpServletRequest request) {
        return error(HttpStatus.NOT_FOUND, "ORDER_NOT_FOUND", exception.getMessage(), request, Map.of());
    }

    @ExceptionHandler(OrderPlacementException.class)
    ResponseEntity<ErrorResponse> orderPlacement(OrderPlacementException exception, HttpServletRequest request) {
